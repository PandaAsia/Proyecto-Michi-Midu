...
Es un proyecto de un juego de 'michi' (tic-tac-toe) en el que practico el uso de React, explorando el funcionamiento de los hooks useState y useEffect para manejar el estado y los efectos en la aplicación.
